...
function SelectGroup({ className, ...props }: SelectPrimitive.Group.Props) {
    return <SelectPrimitive.Group data-slot="select-group" className={clsx("scroll-my-1 p-1", className)} {...props} />;
}
...
function SelectLabel({ className, ...props }: SelectPrimitive.GroupLabel.Props) {
    return (
        <SelectPrimitive.GroupLabel
            ...
            className={clsx("text-muted-foreground px-1.5 py-1 text-xs", className)}
            {...props}
        />
    );
}
